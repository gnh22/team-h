...
Widget _buildContent(CritterViewModel vm) {
  // Error state
  if (vm.error != null) {
    return Center(
      child: Padding(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFF75e0a9),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'No critters match your current time and filters.\nTry checking back at a different time!',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 16,
                color: Colors.black.withOpacity(0.7),
